...
> <!-- TAGLINE:START -->Contributing to 7 open-source packages — **3.3M npm downloads/week** across tracked ecosystem.<!-- TAGLINE:END -->
...
[![Tracked Ecosystem](https://img.shields.io/badge/tracked%20ecosystem-3.3M%2B-brightgreen.svg)](#-live-data)
...
|---------|-------|----------|--------|--------|--------|
| [grafana/grafana](https://github.com/grafana/grafana) | 75.9k | — | 🟢 Open | ![health](evidence/badges/health-grafana.svg) | [#119212](https://github.com/grafana/grafana/pull/119212) |
...
| [kylefox/jquery-modal](https://github.com/kylefox/jquery-modal) | 2.6k | 15.8k | 🟡 Maintainers Wanted | ![health](evidence/badges/health-jquery-modal.svg) | [#315](https://github.com/kylefox/jquery-modal/pull/315), [#316](https://github.com/kylefox/jquery-modal/pull/316), [#317](https://github.com/kylefox/jquery-modal/pull/317) |
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 2.2k | 776.2k | 🔴 Maintainer Gap | ![health](evidence/badges/health-python-shell.svg) | [#320](https://github.com/extrabacon/python-shell/pull/320) |
...
*Across tracked projects:* **<!-- STATS:START -->88.1k stars · 3.3M downloads/week across tracked projects · refreshed 07/31/2026<!-- STATS:END -->**
