...
|---------|-------|----------|--------|--------|--------|
| [grafana/grafana](https://github.com/grafana/grafana) | 74.3k | — | 🟢 Open | ![health](evidence/badges/health-grafana.svg) | [#119212](https://github.com/grafana/grafana/pull/119212) |
...
*Across tracked projects:* **<!-- STATS:START -->86.1k stars · 2.4M downloads/week across tracked projects · refreshed 06/11/2026<!-- STATS:END -->**
