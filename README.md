...
> <!-- TAGLINE:START -->Contributing to 7 open-source packages — **1.6M npm downloads/week** across tracked ecosystem.<!-- TAGLINE:END -->
...
[![Tracked Ecosystem](https://img.shields.io/badge/tracked%20ecosystem-1.6M%2B-brightgreen.svg)](#-live-data)
...
| [extrabacon/python-shell](https://github.com/extrabacon/python-shell) | 2.2k | 208.8k | 🔴 Maintainer Gap | ![health](evidence/badges/health-python-shell.svg) | [#320](https://github.com/extrabacon/python-shell/pull/320) |
...
*Across tracked projects:* **<!-- STATS:START -->84.3k stars · 1.6M downloads/week across tracked projects · refreshed 04/08/2026<!-- STATS:END -->**
